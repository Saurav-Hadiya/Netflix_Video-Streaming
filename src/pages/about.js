...
const About = () => {
    ...
    const getDetails = async () => {
        try {
            ...
            await fetch("https://api.themoviedb.org/3/" + Mediatype + "/" + id + "?&append_to_response=videos&api_key=7bd249c069ed7a0ce955986c55b2f06e")
                .then(res => res.json())
    ...
    return (
        <div class="cover" >
            ...
            <div class="m-1 d-flex">
                {console.log(details)}
                <div class="w-100 ms-0 my-5 content_banner">
                    <div class="">
                        <h1 class="text-light banner_heading">
                            {type == 'movie' ?
                        ...
                        {details.videos?.results?.length > 0 ?
                            <button class="btn btn-light fw-bold px-4 fs-5 mt-4 banner_button" onClick={() => navigate(`/video?details=${details.id}&type=movie`)}>
                                <i class="bi bi-play-fill "></i>
                                Play
                            </button>
                            :
                            <button class="btn btn-secondary fw-bold px-4 fs-5 mt-4 visually-hidden banner_button" disabled>
                                <i class="bi bi-play-fill"></i>
                                Play
                            </button>
                        }
                ...
                <img src={`https://image.tmdb.org/t/p/w500/${details.backdrop_path}`} class="banner_img" />
